...
function draw() {
  ...
  case 0:
    ...
    fill('black') ;
    textSize(24) ;
    text("Welcome to the Game! The white blood cells need your help.", width/2, height/2) ;
    text("Destroy the COVID20 Virus cells. Click to play.", 400, 450) ;
  break ;
...
function Car() {
  ...
  this.g = random(255) ;
  this.b = random(255) ;
  this.diameter = random(10, 20, 65, 150)
